...
``` r
efourier_i(x, nb_h = NULL, nb_pts = 120, ..., .cols = NULL, .name = NULL)
```
...
- x:
  ...
  A numeric vector, list (from raw efourier), list of vectors, or tibble
  with coe columns.
...
[`efourier()`](https://momx.github.io/Momocs2/reference/efourier.md) for
forward transform
